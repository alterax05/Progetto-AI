...
function TPSI() {
  return (
    <div className="flex flex-col items-center min-h-screen justify-center anim_gradient text-white p-8 space-y-5">
        <H1 className="text-center">Progetto TPSI: Riconoscimento di Disegni e Numeri</H1>
        <P>
          In questo progetto sono state sviluppate due intelligenze artificiali
          (AI) in grado di riconoscere disegni e numeri. Entrambe si basano su
          una rete neurale convoluzionale (CNN). La prima AI utilizza un modello
          di apprendimento profondo basato sul dataset{" "}
          <a
        ...
        <P>
          ...
          disegni. Il modello è in grado di riconoscere e classificare 20 dei
          345 tipi di disegni. L'accuratezza di riconoscimento del modello è
          superiore al 92% e risultato molto affidabile durante il test con
          persone. Qui sotto è possibile visualizzare il notebook di Google
          Colab utilizzato per addestrare il modello.
        </P>
        <a
        ...
        <P>
          ...
          modello è stato addestrato su un dataset di immagini di numeri scritti
          a mano in diversi font e stili. (MNIST) Il modello è in grado di
        ...
        <P>
          ...
          processo. Infatti si è passati da un tempo di addestramento di 30
          minuti a 7 minuti nel caso di "Quick, Draw". Per implementare i
          modelli sul Web ci siamo avvalsi del framework "React" e della
          libreria "ONNX". ONNX è un formato di file open-source per la
          rappresentazione di modelli di machine learning.
        </P>
        ...
        <P>
          ...
          overfitting, underfitting o semplicemente a un dataset di
          addestramento non abbastanza ampio. Inoltre il modello MNIST è più
          semplice rispetto a quello di Quick, Draw! e quindi è più facile che
          commetta errori. Esso ha meno filti convoluzionali e meno layer di
          pooling. Non avendo individuato ancora la causa possibile dei problemi
          avevamo preso in consideranzione l'idea di passare ad un'altra
          libreria di deep learning come TensorFlow, ma non è stato possibile
          per mancanza di tempo. A differenza di PyTorch, TensorFlow supporta
          nativate l'ambiente web con la libreria TensorFlow.js.
        </P>
        ...
        <P>
          ...
          l'intelligenza artificiale sono: aumentare il dataset di addestramento
          e provare ad utilizzare altri modelli, magari pre-allenati, come VGG16
          o ResNet50. Inoltre sarebbe utile usare il sistema di feedback per
          validare le previsioni del AI, sostanzialmente implementando
          l'approccio di RFHL (Reinforcement learning from human feedback).
        </P>
        <P>
